...
- 1 место — +10 TIA сверху,
- 2 место — +5 TIA сверху,
- 3 место — +2,5 TIA сверху.
...
Главный Царь обладает правом требовать «десятину» — 10% от всех выигрышей Дао Холдеров (владельцев NFT с гиками), которые побеждают в гивах. Однако он не трогает выигрыши победителей среди [**Gen1 member**](#gen1-member). При этом выбранный Главный Царь месяца не может получить менее 20 $. Если сумма всех собранных «десятин» за месяц окажется меньше, [**Главный Гик**](#главный-гик) компенсирует недостающее — так, чтобы Царь получил минимум $20.

Дополнительно, Главный Царь выбирает роль-фаворита, которая получает возможность участвовать в гивах, на которые обычно не имеет права. Главный Гик добавит роль-фаворита случайно в подходящие гивы. Если при выборе фаворита Царь выбирает роль, которая есть у него самого, то он не может участвовать в гиве для этой роли. В таких гивах участвуют только остальные владельцы этой роли.
...
Если срабатывает у [**Destroyer**](#destroyer), то отключает все особые способности других участников на два месяца, вместо одного.
