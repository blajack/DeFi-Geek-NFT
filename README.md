...
Самая редкая и самая желанная роль. Владелец этой NFT может иметь любое количество NFT из обоих коллекций на своем кошельке, тем самым получая их способности. Получает доступ ко всем чатам и веткам сервера.
